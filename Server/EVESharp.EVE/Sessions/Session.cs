...
public class Session : PyDictionary <PyString, PyDataType>
{
    ...
    /// </summary>
    /// <param name="origin">The dictionary to get the session data from</param>
    ...
    /// <summary>
    /// Applies a session delta to update the session's values
    /// </summary>
    ...
    public long NodeID
    {
        get => this [NODE_ID] as PyInteger ?? 0;
        set => this [NODE_ID] = value;
    }
    public long LoadMetric
    {
        get => this [LOAD_METRIC] as PyInteger ?? 0;
        set => this [LOAD_METRIC] = value;
    }
    public string LanguageID
    {
        get => this [LANGUAGEID] as PyString;
        set => this [LANGUAGEID] = value;
    }
    public int UserID
    {
        get => this [USERID] as PyInteger;
        set => this [USERID] = value;
    }
    public int UserType
    {
        get => this [USER_TYPE] as PyInteger;
    ...
    {
        get => this [CORP_ACCOUNT_KEY] as PyInteger ?? WalletKeys.MAIN;
        set => this [CORP_ACCOUNT_KEY] = value;
    }
    public int SolarSystemID2
    {
        get => this [SOLAR_SYSTEM_ID2] as PyInteger;
        set => this [SOLAR_SYSTEM_ID2] = value;
    }
    public int ConstellationID
    {
        get => this [CONSTELLATION_ID] as PyInteger;
        set => this [CONSTELLATION_ID] = value;
    }
    public int RegionID
    {
        get => this [REGION_ID] as PyInteger;
        set => this [REGION_ID] = value;
    }
    public int HQID
    {
        get => this [HQ_ID] as PyInteger;
        set => this [HQ_ID] = value;
    }
    ...
    {
        get => this [WARFACTION_ID] as PyInteger;
        set => this [WARFACTION_ID] = value;
    }
    public int? RaceID
    {
        get => this [RACE_ID] as PyInteger;
        set => this [RACE_ID] = value;
    }

    public new PyDataType this [PyString index]
    {
