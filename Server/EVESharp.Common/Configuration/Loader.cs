...
{
    public static T LoadSection <T> (IConfiguration configuration) where T : class
    {
        T result = Activator.CreateInstance <T> ();
            
        // get section attribute
        ConfigSection section = typeof (T).GetCustomAttribute <ConfigSection> ();
        ...
        PropertyInfo [] values = typeof (T).GetProperties ();
