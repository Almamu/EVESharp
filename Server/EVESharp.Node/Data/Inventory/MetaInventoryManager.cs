...
public class MetaInventoryManager : IMetaInventoryManager
{
    /// <summary>
    /// Event fired when a new meta inventory is created
    /// </summary>
    public IMetaInventoryManager.MetaInventoryItemEvent OnMetaInventoryCreated { get; set; }
    ...
    public bool GetOwnerInventoryAtLocation (int locationID, int ownerID, Flags flag, out ItemInventoryByOwnerID inventory)
    {
        lock (this.MetaInventories)
        {
            ...
            return this.MetaInventories.TryGetValue (locationID, out Dictionary <int, Dictionary <Flags, ItemInventoryByOwnerID>> inventoriesByOwner) &&
