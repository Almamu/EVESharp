    ...
    public class corpRegistry : MultiClientBoundService
    {
        ...
        public PyDataType UpdateApplicationOffer(PyInteger characterID, PyString text, PyInteger newStatus, PyInteger applicationDateTime, CallInformation call)
        {
            ...
            if (newStatus == 6)
            {
                ...
                // build the notification of corporation change
                Notifications.Client.Corporations.OnCorporationMemberChanged change = new Notifications.Client.Corporations.OnCorporationMemberChanged(characterID, oldCorporationID, corporationID);
                // ensure the database reflects these changes
                this.CharacterDB.UpdateCharacterRoles(
                    characterID, 0, 0, 0,
                    0, 0, 0, 0, 0, 0
        ...
        public PyDataType GetSanctionedActionsByCorporation(PyInteger corporationID, PyInteger status, CallInformation call)
        {
            ...
            return this.DB.GetSanctionedActionsByCorporation(corporationID, status);
        }
        ...
        public PyDataType GetVoteCasesByCorporation(PyInteger corporationID, CallInformation call)
        {
            ...
            return this.DB.GetAllVoteCasesByCorporation(corporationID);
        }
