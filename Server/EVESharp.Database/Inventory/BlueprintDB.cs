...
{
    public static Blueprint InvBpLoad (this IDatabaseConnection Database, Item item)
    {
    ...
    public static void InvBpPersist (this IDatabaseConnection Database, Blueprint info)
    {
        Database.Prepare (
