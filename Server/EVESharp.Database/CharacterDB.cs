...
public static class CharacterDB
{
    ...
    /// <returns></returns>
    public static void ChrSetStasisTimer (this IDatabaseConnection Database, int characterID, long? start)
    {
        Database.Prepare (
    ...
    /// <param name="characterID"></param>
    /// <returns></returns>
    public static long? ChrGetStasisTimer (this IDatabaseConnection Database, int characterID)
    {
    ...
    /// <param name="characterID"></param>
    /// <returns></returns>
    public static PyDataType ChrGetPublicInfo (this IDatabaseConnection Database, int characterID)
    {
    ...
    /// <param name="characterID"></param>
    /// <returns></returns>
    public static Rowset ChrGetPublicInfo3 (this IDatabaseConnection Database, int characterID)
    {
    ...
    /// <param name="characterID"></param>
    /// <returns></returns>
    public static string ChrGetName (this IDatabaseConnection Database, int characterID)
    {
        IDataReader reader = Database.Select (
    ...
    public static void ChrSetNote (this IDatabaseConnection Database, int itemID, int ownerID, string note)
    {
    ...
    /// <param name="ownerID"></param>
    /// <returns></returns>
    public static string ChrGetNote (this IDatabaseConnection Database, int itemID, int ownerID)
    {
        IDataReader reader = Database.Select (
    ...
    /// </summary>
    /// <param name="characterID"></param>
    public static void ChrUpdateLogonTime (this IDatabaseConnection Database, int characterID)
    {
        Database.Prepare (
