...
{
    public static Rowset EveMailGetHeaders (this IDatabase Database, int characterID)
    {
    ...
    public static PyTuple EveMailGetMessages (this IDatabase Database, int channelID, int messageID)
    {
    ...
    public static void EveMailMarkMessagesRead (this IDatabase Database, int mailboxID, PyList <PyInteger> messageIDs)
    {
        Database.Query (
    ...
    public static void EveMailDeleteMessages (this IDatabase Database, int mailboxID, PyList <PyInteger> messageIDs)
    {
    ...
    public static ulong EveMailStore (this IDatabase Database, int channelID, int senderID, string subject, string message, out string mailboxType)
    {
        ulong messageID = Database.Insert (
